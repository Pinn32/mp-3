    ...
    <>
      ...
      <StyledMainContent>
        ...
        <ul>
          ...
          <li>Collaborated with teachers to develop effective learning plans.</li>
          <li>Assisted students with vocabulary, grammar, and sentence structure.</li>
          <li>Provided emotional support to reduce exam stress.</li>
          <li>Contributed to teaching research with proactive suggestions and extra tasks.</li>
        </ul>
        ...
        <ul>
          ...
          <li>Analyzed customer profiles and behavior to optimize campaigns.</li>
          <li>Researched competitors&apos; strategies to identify improvements.</li>
          <li>Translated and created promotional brochures and technical manuals.</li>
        </ul>
        ...
        <ul>
          ...
          <li>Organized cross-cultural events that fostered interaction among 100+ students.</li>
